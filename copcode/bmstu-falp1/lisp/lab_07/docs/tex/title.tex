\begin{titlepage}
	...
	\begin{center}
		\Large\textbf{Отчёт по лабораторной работе №7 по курсу <<Функциональное и логическое программирование>>}
	\end{center}
	
	\bigskip\bigskip
	
	\noindent\textbf{Тема} $\underline{\text{Использование рекурсии}}$\newline\newline\newline
