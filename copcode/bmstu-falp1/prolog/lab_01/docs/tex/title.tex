\begin{titlepage}
	...
	\begin{center}
		\Large\textbf{Отчёт по лабораторной работе №10 по курсу <<Функциональное и логическое программирование>>}
	\end{center}
	
	\bigskip\bigskip
	
	\noindent\textbf{Тема} $\underline{\text{Среда Visual Prolog 5.2}}$\newline\newline\newline
